...
@XmlRootElement(name = "GetTosContainerInfo")
public class GetTosContainerInfo {

    @XmlElementRef(name = "containerNumber", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
